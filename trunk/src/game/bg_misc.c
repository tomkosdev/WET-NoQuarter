 ...
 *
 * NQQS:		TODO: several functions are not used in both games!
 *
 */
#ifdef CGAMEDLL
...
// [5] = skillclip		-	extra ammo for promotion
// [6] = reloadTime		-	time from start of reload until ready to fire.
// [7] = fireDelayTime	-	time from pressing 'fire' until first shot is fired. (used for delaying fire while weapon is 'readied' in animation)
// [8] = nextShotTime	-	when firing continuously, this is the time between shots
// [9] = maxHeat		-	max active firing time before weapon 'overheats' (at which point the weapon will fail for a moment)
// [10] = coolRate		-	how fast the weapon cools down.
// [11] = mod			-	means of death
// [12] = clipindex		-	weapon-number of the clip the weapon is using (for clip-sharing weapons).  Note: these entries are filled in at runtime
// [13] = ammoindex		-	weapon-number of the ammo the weapon is using (for ammo-sharing weapons).  Note: these entries are filled in at runtime
// [14] = isAutoReload	-	is an auto reload weapon
...
weapontable_t WeaponTable[WP_NUM_WEAPONS] = // TomekKromek
{
	...
	{	0,		0,		0,		0,		0,		0,		0,		50,				0,		0,		0,		MOD_UNKNOWN,				0,		0,		qfalse,	qfalse,	qfalse	},	// WP_NONE					// 0
	{	8,		0,		8,		0,		4,		0,		0,		DELAY_VERY_LOW,	200,	0,		0,		MOD_KNIFE,					0,		0,		qfalse,	qtrue,	qfalse	},	// WP_KNIFE					// 1
	{	24,		1,		8,		24,		8,		8,		1500,	DELAY_LOW,		400,	0,		0,		MOD_LUGER,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_LUGER					// 2	// NOTE: also 32 round 'snail' magazine
	{	90,		1,		30,		30,		30,		30,		2400,	DELAY_LOW,		150,	0,		0,		MOD_MP40,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_MP40					// 3
	{	45,		1,		15,		0,		4,		0,		1000,	DELAY_THROW,	1600,	0,		0,		MOD_GRENADE_LAUNCHER,		0,		0,		qfalse,	qtrue,	qfalse	},	// WP_GRENADE_LAUNCHER		// 4
	{	4,		1,		1,		0,		4,		1,		1000,	DELAY_HW	,	2000,	0,		0,		MOD_PANZERFAUST,			0,		0,		qfalse,	qfalse,	qtrue	},	// WP_PANZERFAUST			// 5	// DHM - Nerve :: updated delay so prediction is correct
	{	200,	1,		200,	0,		200,	75,		1000,	DELAY_LOW,		50,		0,		0,		MOD_FLAMETHROWER,			0,		0,		qfalse,	qfalse,	qtrue	},	// WP_FLAMETHROWER			// 6
	{	24,		1,		8,		24,		8,		8,		1500,	DELAY_LOW,		400,	0,		0,		MOD_COLT,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_COLT					// 7
	{	90,		1,		30,		30,		30,		30,		2400,	DELAY_LOW,		150,	0,		0,		MOD_THOMPSON,				0,		0,		qtrue,	qtrue,	qfalse	},	// WP_THOMPSON				// 8
	{	45,		1,		15,		0,		4,		0,		1000,	DELAY_THROW,	1600,	0,		0,		MOD_GRENADE_PINEAPPLE,		0,		0,		qfalse,	qtrue,	qfalse	},	// WP_GRENADE_PINEAPPLE		// 9

	{	96,		1,		32,		64,		32,		32,		3100,	DELAY_LOW,		150,	1200,	450,	MOD_STEN,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_STEN					// 10
	{	10,		1,		1,		0,		10,		0,		1500,	DELAY_VERY_LOW,	1000,	0,		0,		MOD_SYRINGE,				0,		0,		qfalse,	qtrue,	qfalse	},	// WP_MEDIC_SYRINGE			// 11
	{	1,		0,		1,		0,		0,		0,		3000,	DELAY_VERY_LOW,	1000,	0,		0,		MOD_AMMO,					0,		0,		qfalse,	qtrue,	qfalse	},	// WP_AMMO					// 12
	{	1,		0,		1,		0,		1,		0,		3000,	DELAY_VERY_LOW,	1000,	0,		0,		MOD_ARTY,					0,		0,		qfalse,	qfalse,	qfalse	},	// WP_ARTY					// 13
	{	24,		1,		8,		24,		8,		8,		1500,	DELAY_LOW,		400,	0,		0,		MOD_SILENCER,				0,		0,		qtrue,	qtrue,	qfalse	},	// WP_SILENCER				// 14
	{	1,		0,		10,		0,		0,		0,		1000,	DELAY_THROW,	1600,	0,		0,		MOD_DYNAMITE,				0,		0,		qfalse,	qtrue,	qfalse	},	// WP_DYNAMITE				// 15
	{	999,	0,		999,	0,		0,		0,		0,		DELAY_VERY_LOW,	0,		0,		0,		0,							0,		0,		qfalse,	qfalse,	qfalse	},	// WP_SMOKETRAIL			// 16

	{	0,		0,		0,		0,		0,		0,		0,		DELAY_VERY_LOW,	0,		0,		0,		0,							0,		0,		qfalse,	qfalse,	qfalse	},	// VERYBIGEXPLOSION			// 17

	{	999,	0,		999,	1,		1,		0,		0,		DELAY_VERY_LOW,	1000,	0,		0,		0,							0,		0,		qfalse,	qtrue,	qfalse	},	// WP_MEDKIT				// 18
	{	999,	0,		999,	0,		0,		0,		0,		DELAY_VERY_LOW,	0,		0,		0,		0,							0,		0,		qfalse,	qtrue,	qfalse	},	// WP_BINOCULARS			// 19

	{	999,	0,		999,	0,		0,		0,		0,		DELAY_VERY_LOW,	50,		0,		0,		0,							0,		0,		qfalse,	qtrue,	qfalse	},	// WP_PLIERS				// 20
	{	999,	0,		999,	0,		1,		0,		0,		DELAY_VERY_LOW,	1000,	0,		0,		MOD_AIRSTRIKE,				0,		0,		qfalse,	qtrue,	qfalse	},	// WP_SMOKE_MARKER			// 21
	{	30,		1,		10,		20,		10,		10,		2500,	DELAY_LOW,		400,	0,		0,		MOD_KAR98,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_KAR98					// 22		K43
	{	30,		1,		10,		20,		10,		10,		1500,	DELAY_LOW,		400,	0,		0,		MOD_CARBINE,				0,		0,		qtrue,	qtrue,	qfalse	},	// WP_CARBINE				// 23		GARAND (Engineer)
	{	30,		1,		10,		20,		10,		10,		1500,	DELAY_LOW,		400,	0,		0,		MOD_GARAND,					0,		0,		qtrue,	qfalse,	qfalse	},	// WP_GARAND				// 24		GARAND (Covert)
	{	1,		0,		1,		0,		1,		0,		100,	DELAY_LOW,		100,	0,		0,		MOD_LANDMINE,				0,		0,		qfalse,	qtrue,	qfalse	},	// WP_LANDMINE				// 25
	{	1,		0,		1,		0,		0,		0,		3000,	DELAY_LOW,		2000,	0,		0,		MOD_SATCHEL,				0,		0,		qfalse,	qfalse,	qfalse	},	// WP_SATCHEL				// 26
	{	1,		0,		1,		0,		0,		0,		3000,	722,			2000,	0,		0,		0,							0,		0,		qfalse,	qfalse,	qfalse	},	// WP_SATCHEL_DET			// 27
	{	1,		0,		10,		0,		1,		0,		1000,	DELAY_THROW,	1600,	0,		0,		MOD_SMOKEBOMB,				0,		0,		qfalse,	qtrue,	qfalse	},	// WP_SMOKE_BOMB			// 28
	{	450,	1,		150,	0,		150,	150,	3000,	DELAY_LOW,		66,		1500,	300,	MOD_MOBILE_MG42,			0,		0,		qtrue,	qfalse,	qtrue	},	// WP_MOBILE_MG42			// 29

	{	30,		1,		10,		20,		10,		10,		2500,	DELAY_LOW,		400,	0,		0,		MOD_K43,					0,		0,		qtrue,	qfalse,	qfalse	},	// WP_K43					// 30		K43
	{	60,		1,		20,		40,		20,		20,		2000,	DELAY_LOW,		100,	0,		0,		MOD_FG42,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_FG42					// 31
	{	0,		0,		0,		0,		0,		0,		0,	    DELAY_NO,		0,	    1500,	300,	0,						    0,		0,		qfalse,	qfalse,	qfalse	},	// WP_DUMMY_MG42			// 32
	{	15,		1,		1,		0,		0,		2,		0,		DELAY_HW,		1600,	0,		0,		MOD_MORTAR,					0,		0,		qfalse,	qfalse,	qtrue	},	// WP_MORTAR				// 33
	{	48,		1,		8,		48,		8,		8,		2700,	DELAY_LOW,		200,	0,		0,		MOD_AKIMBO_COLT,			0,		0,		qtrue,	qtrue,	qfalse	},	// WP_AKIMBO_COLT			// 34
	{	48,		1,		8,		48,		8,		8,		2700,	DELAY_LOW,		200,	0,		0,		MOD_AKIMBO_LUGER,			0,		0,		qtrue,	qtrue,	qfalse	},	// WP_AKIMBO_LUGER			// 35
	{	4,		1,		1,		4,		1,		4,		3000,	DELAY_LOW,		400,	0,		0,		MOD_GPG40,					0,		0,		qfalse,	qfalse,	qfalse	},	// WP_GPG40					// 36
	{	4,		1,		1,		4,		1,		4,		3000,	DELAY_LOW,		400,	0,		0,		MOD_M7,						0,		0,		qfalse,	qfalse,	qfalse	},	// WP_M7					// 37
	{	24,		1,		8,		24,		8,		8,		1500,	DELAY_LOW,		400,	0,		0,		MOD_SILENCED_COLT,			0,		0,		qtrue,	qtrue,	qfalse	},	// WP_SILENCED_COLT			// 38
	{	30,		1,		10,		20,		10,		10,		1500,	DELAY_NO,		400,	0,		0,		MOD_GARAND_SCOPE,			0,		0,		qtrue,	qfalse,	qfalse	},	// WP_GARAND_SCOPE			// 39		GARAND

	{	30,		1,		10,		20,		10,		10,		2500,	DELAY_NO,		400,	0,		0,		MOD_K43_SCOPE,				0,		0,		qtrue,	qfalse,	qfalse	},	// WP_K43_SCOPE				// 40		K43
	{	60,		1,		20,		40,		20,		10,		2000,	DELAY_LOW,		400,	0,		0,		MOD_FG42_SCOPE,				0,		0,		qtrue,	qfalse,	qfalse	},	// WP_FG42_SCOPE			// 41
	{	16,		1,		1,		12,		0,		2,		0,		DELAY_HW,		1400,	0,		0,		MOD_MORTAR,					0,		0,		qfalse,	qfalse,	qfalse	},	// WP_MORTAR_SET			// 42
	{	10,		1,		1,		0,		10,		0,		1500,	DELAY_VERY_LOW,	1000,	0,		0,		MOD_SYRINGE,				0,		0,		qfalse,	qtrue,	qfalse	},	// WP_MEDIC_ADRENALINE		// 43
	{	48,		1,		8,		48,		8,		8,		2700,	DELAY_LOW,		200,	0,		0,		MOD_AKIMBO_SILENCEDCOLT,	0,		0,		qtrue,	qtrue,	qfalse	},	// WP_AKIMBO_SILENCEDCOLT	// 44
	{	48,		1,		8,		48,		8,		8,		2700,	DELAY_LOW,		200,	0,		0,		MOD_AKIMBO_SILENCEDLUGER,	0,		0,		qtrue,	qtrue,	qfalse	},	// WP_AKIMBO_SILENCEDLUGER	// 45
	{	450,	1,		150,	0,		150,	150,	3000,	DELAY_LOW,		66,		1500,	300,	MOD_MOBILE_MG42,			0,		0,		qtrue,	qfalse,	qfalse	},	// WP_MOBILE_MG42_SET		// 46
	{	24,		1,		6,		24,		6,		8,		1500,	DELAY_LOW,		850,	0,		0,		MOD_SHOTGUN,				0,		0,		qtrue,	qtrue,	qfalse	},	// WP_SHOTGUN				// 47		Winchester Model 97
	{	8,		0,		8,		0,		4,		0,		0,		DELAY_VERY_LOW,	200,	0,		0,		MOD_KNIFE,					0,		0,		qfalse,	qtrue,	qfalse	},	// WP_KNIFE_KABAR			// 48		Allied Knife
	{	450,	1,		150,	0,		150,	150,	3000,	DELAY_LOW,		66,		1400,	400,	MOD_MOBILE_BROWNING,		0,		0,		qtrue,	qfalse,	qtrue	},	// WP_MOBILE_BROWNING		// 49		Browning .30 cal

	{	450,	1,		150,	0,		150,	150,	3000,	DELAY_LOW,		66,		1400,	400,	MOD_MOBILE_BROWNING,		0,		0,		qtrue,	qfalse,	qfalse	},	// WP_MOBILE_BROWNING_SET	// 50		Browning .30 cal set
	{	80,		1,		20,		60,		20,		20,		2000,	DELAY_LOW,		150,	0,		0,		MOD_BAR, 					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_BAR					// 51		Browning Automatic Rifle
	{	80,		1,		20,		60,		20,		20,		2000,	DELAY_LOW,		165,	0,		0,		MOD_BAR, 					0,		0,		qtrue,	qfalse,	qfalse	},	// WP_BAR_SET				// 52		Browning Automatic Rifle (Set)
	{	90,		1,		30,		30,		30,		30,		2400,	DELAY_LOW,		180,	0,		0,		MOD_STG44,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_STG44					// 53		StG44 Assault Rifle
	{	60,		1,		20,		40,		20,		10,		2000,	DELAY_LOW,		100,	0,		0,		MOD_JOHNSON,				0,		0,		qtrue,	qfalse,	qfalse	},	// WP_JOHNSON				// 54		Johnson M41 LMG
	{	5,		1,		1,		0,		5,		1,		900,	DELAY_HW,		2000,	0,		0,		MOD_BAZOOKA,				0,		0,		qfalse,	qfalse,	qtrue	},	// WP_BAZOOKA				// 55		M1 Bazooka Anti-Tank Weapon
	{	96,		1,		32,		64,		32,		32,		3100,	DELAY_LOW,		150,	1100,	550,	MOD_MP34,					0,		0,		qtrue,	qtrue,	qfalse	},	// WP_MP34					// 56		Solothurn S1-100 SMG
	{	15,		1,		1,		0,		0,		2,		0,		DELAY_HW,		1600,	0,		0,		MOD_MORTAR,					0,		0,		qfalse,	qfalse,	qtrue	},	// WP_MORTAR2				// 57
	{	16,		1,		1,		12,		0,		2,		0,		DELAY_HW,		1400,	0,		0,		MOD_MORTAR,					0,		0,		qfalse,	qfalse,	qfalse	},	// WP_MORTAR2_SET			// 58
	{	500,	1,		250,	0,		250,	250,	3000,	DELAY_HW,		45,		2500,	200,	MOD_VENOM,					0,		0,		qfalse,	qfalse,	qfalse	},	// WP_VENOM					// 59

	{	10,		1,		1,		0,		10,		0,		1500,	DELAY_VERY_LOW,	1000,	0,		0,		MOD_POISON,					0,		0,		qfalse,	qtrue,	qfalse	},	// WP_POISON_SYRINGE		// 60

	{	0,		0,		0,		0,		0,		0,		0,		50,				0,		0,		0,		MOD_KICKED,					0,		0,		qfalse,	qfalse,	qfalse	},	// WP_FOOTKICK				// 61
	{	60,		1,		20,		40,		20,		10,		2000,	DELAY_LOW,		400,	0,		0,		MOD_JOHNSON_SCOPE,			0,		0,		qtrue,	qfalse,	qfalse	},	// WP_JOHNSON_SCOPE			// 82		Johnson M41 LMG
};
...
int weapAlts[] =
{
	...
	WP_NONE,				// 53 WP_STG44
	WP_JOHNSON_SCOPE,		// 54 WP_JOHNSON
	...
	WP_JOHNSON,				// 62 WP_JOHNSON_SCOPE
...
int weapTeamConversion[] =
{
	...
	WP_JOHNSON_SCOPE,		// 41 WP_FG42SCOPE
	...
	WP_FG42SCOPE,			// 62 WP_JOHNSON_SCOPE
							//    WP_NUM_WEAPONS
};

// core: weapons that can be disabled..
/* IRATA: not used ?!
int weaponCanDisable[WP_NUM_CAN_DISABLE] =
{
	WP_GRENADE_LAUNCHER,
	WP_PANZERFAUST,
	WP_FLAMETHROWER,
...
/*
 *  core: weapons that can be restricted using the nq_weapons.cfg restrictions config file..
 */
int weaponCanRestrict[WP_NUM_CAN_RESTRICT] =
{
	WP_PANZERFAUST,
	WP_FLAMETHROWER,
	WP_KAR98,				// WP_GPG40
	WP_CARBINE,				// WP_M7
	WP_GARAND,				// WP_GARAND_SCOPE
	WP_LANDMINE,
	WP_MOBILE_MG42,			// WP_MOBILE_MG42_SET
	WP_K43,					// WP_K43_SCOPE
	WP_FG42,				// WP_FG42SCOPE
	WP_MORTAR,				// WP_MORTAR_SET
	WP_JOHNSON,				// WP_JOHNSON_SCOPE
	WP_SHOTGUN,
	WP_MOBILE_BROWNING,		// WP_MOBILE_BROWNING_SET
	WP_BAZOOKA,
	WP_MORTAR2,				// WP_MORTAR2_SET
	WP_VENOM
};
...
int modWeaponTableMP[MOD_NUM_MODS][4] =
{
	...
	{ WP_FOOTKICK,				WP_NONE,				WP_NONE,	WP_NONE },			// MOD_GOOMBA,
	...
	{ WP_JOHNSON,				WP_NONE,				WP_NONE,	WP_NONE },			// MOD_JOHNSON,
	...
	{ WP_JOHNSON_SCOPE,			WP_NONE,				WP_NONE,	WP_NONE }			// MOD_JOHNSON_SCOPE
};
...
qboolean modHeadshotModeWeapon[MOD_NUM_MODS] =
{
	...
	qfalse,					//MOD_SHOVE,
	qfalse,					//MOD_THROWKNIFE,
	qtrue,					//MOOD_JOHNSON_SCOPE
};


char *WP_names[WP_NUM_WEAPONS] = {
	"WP_NONE",					// 0  WP_NONE
	"WP_KNIFE",					// 1  WP_KNIFE
	"WP_LUGER",					// 2  WP_LUGER
	"WP_MP40",					// 3  WP_MP40
	"WP_GRENADE_LAUNCHER",		// 4  WP_GRENADE_LAUNCHER
	"WP_PANZERFAUST",			// 5  WP_PANZERFAUST
	"WP_FLAMETHROWER",			// 6  WP_FLAMETHROWER
	"WP_COLT",					// 7  WP_COLT
	"WP_THOMPSON",				// 8  WP_THOMPSON
	"WP_GRENADE_PINEAPPLE",		// 9  WP_GRENADE_PINEAPPLE
	"WP_STEN",					// 10 WP_STEN
	"WP_MEDIC_SYRINGE",			// 11 WP_MEDIC_SYRINGE
	"WP_AMMO",					// 12 WP_AMMO
	"WP_ARTY",					// 13 WP_ARTY
	"WP_SILENCER",				// 14 WP_SILENCER
	"WP_DYNAMITE",				// 15 WP_DYNAMITE
	"WP_SMOKETRAIL",			// 16 WP_SMOKETRAIL
	"VERYBIGEXPLOSION",			// 17 VERYBIGEXPLOSION
	"WP_MEDKIT",				// 18 WP_MEDKIT
	...
	"WP_PLIERS",				// 20 WP_PLIERS
	"WP_SMOKE_MARKER",			// 21 WP_SMOKE_MARKER
	"WP_KAR98",					// 22 WP_KAR98
	"WP_CARBINE",				// 23 WP_CARBINE (GARAND really)
	"WP_GARAND",				// 24 WP_GARAND
	"WP_LANDMINE",				// 25 WP_LANDMINE
	"WP_SATCHEL",				// 26 WP_SATCHEL
	"WP_SATCHEL_DET",			// 27 WP_SATCHEL_DET
	"WP_SMOKE_BOMB",			// 28 WP_SMOKE_BOMB
	"WP_MOBILE_MG42",			// 29 WP_MOBILE_MG42
	"WP_K43",					// 30 WP_K43
	"WP_FG42",					// 31 WP_FG42
    "WP_DUMMY_MG42",         	// 32 WP_DUMMY_MG42
	"WP_MORTAR",				// 33 WP_MORTAR
	"WP_AKIMBO_COLT",			// 34 WP_AKIMBO_COLT
	"WP_AKIMBO_LUGER",			// 35 WP_AKIMBO_LUGER
	"WP_GPG40",					// 36 WP_GPG40
	"WP_M7",					// 37 WP_M7
	"WP_SILENCED_COLT",			// 38 WP_SILENCED_COLT
	"WP_GARAND_SCOPE",			// 39 WP_GARAND_SCOPE
	"WP_K43_SCOPE",				// 40 WP_K43_SCOPE
	"WP_FG42SCOPE",				// 41 WP_FG42SCOPE
	"WP_MORTAR_SET",			// 42 WP_MORTAR_SET
	"WP_MEDIC_ADRENALINE",		// 43 WP_MEDIC_ADRENALINE
	"WP_AKIMBO_SILENCEDCOLT",	// 44 WP_AKIMBO_SILENCEDCOLT
	"WP_AKIMBO_SILENCEDLUGER",	// 45 WP_AKIMBO_SILENCEDLUGER
	"WP_MOBILE_MG42_SET",		// 46 WP_MOBILE_MG42_SET
	"WP_SHOTGUN",				// 47 WP_SHOTGUN
	"WP_KNIFE_KABAR",			// 48 WP_KNIFE_KABAR
	"WP_MOBILE_BROWNING",		// 49 WP_MOBILE_BROWNING
	"WP_MOBILE_BROWNING_SET",	// 50 WP_MOBILE_BROWNING_SET
	"WP_BAR",					// 51 WP_BAR
	"WP_BAR_SET",				// 52 WP_BAR_SET
	"WP_STG44",					// 53 WP_STG44
	"WP_JOHNSON",				// 54 WP_JOHNSON
	"WP_BAZOOKA",				// 55 WP_BAZOOKA
	"WP_MP34",					// 56 WP_MP34
	"WP_MORTAR2",				// 57 WP_MORTAR2
	"WP_MORTAR2_SET",			// 58 WP_MORTAR2_SET
	"WP_VENOM",					// 59 WP_VENOM
	"WP_POISON_SYRINGE",		// 60 WP_POISON_SYRINGE
	"WP_FOOTKICK",				// 61 WP_FOOTKICK
	"WP_JOHNSON_SCOPE"			// 62 WP_JOHNSON_SCOPE
};
...
// IRATA
// pickup_sound not used for real anymore - kept as info and to catch if there is a sound or not
// see cg_event.c ITEM_PICKUP events and CG_PlayItemPickupSound()
gitem_t	bg_itemlist[] =
{
	//---------------------------------
	// index 0
	{
		NULL,					// classname
		-1,						// hash
		NULL,					// pickup_sound // IRATA: not used for real anymore - kept as info
		{
			0,					// world_model[0]
			0,					// world_model[1]
			0					// world_model[2]
	...
	// index 1: powerups, item & addons
	{
		"item_adrenaline",
		197679,
		"", // TODO: adding a special sound on private channel?
	...
	*/
	...
	// index 34
	{
		...
		300497,
		"sound/misc/w_pkup.wav", // IRATA: 've never heard this
	...
	*/
	...
	// index 49
	{
		"weapon_binoculars",
		231087,
		"sound/misc/w_pkup.wav", // IRATA: 've never heard this - see dogtags
	...
	// index 79 // JOHNSON
	{
		...
		"sound/misc/w_pkup.wav",
		// FIXME!
		 { "models/weapons2/johnson/johnson.md3", "models/weapons2/fg42/v_fg42.md3", "models/weapons2/fg42/pu_fg42.md3" }, // FIXME!
		"icons/iconw_johnson_1", "icons/ammo5",
		"Johnson",
		10,
		IT_WEAPON, WP_JOHNSON, WP_JOHNSON, WP_JOHNSON
	},

	// index 80 // JOHNSON SCOPE
	{
		"weapon_Johnson_Scope",
		275604,
		"sound/misc/w_pkup.wav",
		// FIXME! - johnson is ready ...
		 { "models/weapons2/johnson/johnson.md3", "models/weapons2/fg42/v_fg42.md3", "models/weapons2/fg42/pu_fg42.md3" }, // FIXME!
		"icons/iconw_johnson_1", "icons/ammo5",
		"Johnson Scope",
		0,
		IT_WEAPON, WP_JOHNSON_SCOPE, WP_JOHNSON, WP_JOHNSON
	},
	...
	// index 87
	{
		"ammo_dynamite",
		172551,
		"sound/misc/am_pkup.wav",  // IRATA: 've never heard this
        { 0, 0, 0 },
		"", NULL,
		"dynamite",
		1,
	...
	// index 112 JOHNSON
	{
		...
		160471,
		"sound/misc/am_pkup.wav",
		{ "models/ammo/fg42.md3", 0, 0 }, // FIXME: own md3 for the johnson?
		"", NULL,
		"Johnson Clip",
		20,
		IT_AMMO, WP_JOHNSON, WP_JOHNSON, WP_JOHNSON
	},
...
qboolean BG_AddMagicAmmo( playerState_t *ps, int *skillBits, int teamNum, int numOfClips ) {
	...
	// reloadable weapons..
// TODO: This is a terrible piece of code ...
...
weapon_t BG_GetPrimaryWeaponForPlayerState( playerState_t *ps ) {
	...
	if ( COM_BitCheck( ps->weapons, WP_BAZOOKA ) )	{
		...
		primary = WP_STEN;
	} else if ( COM_BitCheck( ps->weapons, WP_JOHNSON ) )	{
		primary = WP_JOHNSON;
...
void BG_PlayerStateToEntityState( playerState_t *ps, entityState_t *s, int time, qboolean snap ) {
	...
	if(ps->pm_type == PM_INTERMISSION || ps->pm_type == PM_SPECTATOR || ps->stats[STAT_HEALTH] <= GIB_HEALTH ) { // JPW NERVE limbo
...
// end
	...
	for ( i = 0 ; i < MAX_POWERUPS ; i++ ) {
		if ( ps->powerups[ i ] ) {
			// core: because the adrenaline value can also be negative,
			// and the clientstate only has bitflags,
			// we must only set the flag if the adrenaline value is positive (indicates "adrenaline is in use")..
			if (i == PW_ADRENALINE) {
				if (ps->powerups[i] > 0) {
					s->powerups |= 1 << i;
				}
...
and after local prediction on the client
========================
IRATA unused: skip correction is all handled server-side now ... see g_active.c ClientThink_doPmove
...
void BG_PlayerStateToEntityStateExtraPolate( playerState_t *ps, entityState_t *s, qboolean snap )
{
	...
	s->pos.trDuration = SERVER_FRAMETIME; // 1000 / sv_fps (default = 20)
...
gitem_t* BG_ValidStatWeapon( weapon_t weap ) {
	...
	switch(weap) {
		...
		case WP_MEDIC_ADRENALINE: // IRATA added - doesn't kill
		case WP_SMOKE_BOMB:
		case WP_AMMO:
 		case VERYBIGEXPLOSION: // IRATA added since there is no BG_WeaponInWolfMP() anymore
		case WP_FOOTKICK:   // foot kick is real weapon and kills ... do we need gitem_t ?
			return NULL;
		default:
			break;
	}
...
weapon_t BG_WeaponForMOD( int MOD ) {
	...
	if ( MOD == MOD_BACKSTAB || MOD == MOD_THROWKNIFE ) {
		// what about allies/axis case -> WP_KNIFE_KABAR ?
		return WP_KNIFE;
	}
...
int BG_ExtraAmmoForWeapon( weapon_t weaponNum, int *skillBits, int playerType ) {
	...
	switch( weaponNum ) {
		...
		case WP_BAR_SET:
		case WP_SHOTGUN:
			extraAmmo = WeaponTable[weaponNum].skillclip * extraClips;
			break;
		...
		case WP_GPG40:
			if ( skillBits[SK_EXPLOSIVES_AND_CONSTRUCTION] & (1<<1) ) {
				extraAmmo = WeaponTable[weaponNum].skillclip;
			}
			break;
...
const weap_ws_t aWeaponInfo[WS_MAX] =
{
	...
	// TODO: check if we need case WP_GRENADE_PINEAPPLE
	...
	{ WP_SATCHEL,				"STCH",	"Satchel"		},	// 14 WS_SATCHEL
	{ WP_GPG40,					"GRLN", "G.Launchr"		},	// 15 WS_GRENADELAUNCHER
	{ WP_LANDMINE,				"LNMN", "Landmine"		},	// 16 WS_LANDMINE
	{ WP_MOBILE_MG42_SET,		"MG42",	"MG-42 Gun"		},	// 17 WS_MG42
	{ WP_GARAND,				"GARN",	"Garand"		},	// 18 WS_GARAND
	{ WP_K43,					"K-43",	"K43 Rifle"		},	// 19 WS_K43
	{ WP_SHOTGUN,				"SHOT", "Shotgun"		},  // 20 WS_SHOTGUN
	{ WP_MOBILE_BROWNING_SET,	"BRNG", "Browning MG"	},	// 21 WS_BROWNING
	{ WP_STG44,					"MP44", "StG 44"		},	// 22 WS_STG44
	{ WP_BAR_SET,				"BAR ", "BAR"			},	// 23 WS_BAR
	{ WP_BAZOOKA,				"BAZ ", "Bazooka"		},  // 24 WS_BAZOOKA
	{ WP_MP34,					"MP34",	"MP34"			},  // 25 WS_MP34
	{ WP_VENOM,					"VENM",	"Venom"			},	// 26 WS_VENOM
	{ WP_POISON_SYRINGE,		"POIS", "Poison"		},	// 27 WS_POISON
	{ WP_FOOTKICK,				"FOOT", "Foot Kick"		},	// 28 WS_FOOTKICK
	{ WP_JOHNSON,				"JOHN", "Johnson"		},	// 28 WS_JOHNSON
};
...
// see  WeaponTable !? why this? this function is used 1 x ...
qboolean BG_isLightWeaponSupportingFastReload( int weapon ) {
	switch (weapon) {
		...
		case WP_BAR:
		case WP_MP34:
		case WP_JOHNSON: // TODO: test this!
			return qtrue;
		default:
			return qfalse;
	}
