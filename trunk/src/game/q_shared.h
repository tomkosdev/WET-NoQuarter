...
#pragma warning (disable : 4706)				// jaquboss - "=" in conditions
...
// core: this is the define for using SSE assembler code..
...
#else
#ifdef _M_IX86
#define	CPUSTRING	"win-x86-debug" // FIXME: is this right? it doesn't appear to be for client ...
#elif defined _M_ALPHA
...
// Lucel: Why was this not a constant?
...
#define PROP_SMALL_SIZE_SCALE	0.75 // never used - see also  q_splineshared.h
...
#define UI_BIGFONT		0x00000020	// ui_credits.c
...
#define MICROCHAR_WIDTH		5
#define MICROCHAR_HEIGHT	10
...
// IRATA: Use this in combination with level.time and extend in case of missing time
// it'll make the code more transparent ... see above
#define SECOND_HALF         500
#define	SECONDS_1			1000					// 1 sec int
#define	SECONDS_1_F			1000.f					// 1 sec float
#define	SECONDS_2			2000					// 2 secs
#define SECONDS_2_5			2500
#define	SECONDS_2_F			2000.f					// 2 secs
#define	SECONDS_3			3000					// 3 ...
#define	SECONDS_3_F			3000.f
#define	SECONDS_4			4000					// ...
#define	SECONDS_4_F			4000.f
#define	SECONDS_5			5000
#define	SECONDS_5_F			5000.f
#define SECONDS_6			6000
#define	SECONDS_7			7000

#define	SECONDS_9			9000

#define	SECONDS_10			10000
#define	SECONDS_15			15000
#define	SECONDS_20			20000
#define	SECONDS_25			25000
#define	SECONDS_30			30000
#define	SECONDS_30_F		30000.f
...
// core: faster versions (but less accurate)
...
// core: SinCos macro
// IRATA: fixed gnu asm SinCos but I'm not sure if this grants advantages
// see mathcalls sincos(rad,s,c); which is not used atm ... (__USE_GNU is not set)
...
#if id386 && ( defined __GNUC__ ) && ( defined __linux__ || defined __FreeBSD__ )
// WIP !
#define SinCos(rad,s,c)	    \
	__asm__ ("fsincos;" : "=t" (c), "=u" (s) : "0" (rad) : "st(7)");
#else
#if id386 && (defined WIN32) && !( defined __GNUC__ )
#define SinCos(rad,s,c)		\
	__asm fld (rad)			\
	__asm fsincos			\
	__asm fstp (c)			\
...
void 	COM_StripExtensionSafe( const char *in, char *out, int destsize ); // IRATA: added ensiform's security fix
...
// core: Capitalize only the first character in the string
...
#ifdef CHEATS
#define CVAR_CHEAT			0	// jet pilot - allow full cheats during debugging
#else
...
#define MAX_GENTITIES_IN_A_BOX 256 // IRATA: used for trap_EntitiesInBox within a small range - MAX_GENTITIES in that case

// IlDuca - ported from ETPub
...
#define NULL_MODEL 			0		// IRATA: model not loaded - TODO: add this to engine is ever maintained!
...
#define	BUTTON_USE_HOLDABLE	4			// jet Pilot - hijackable?
#define	BUTTON_GESTURE		8			// jet Pilot - hijackable?
...
// jet Pilot - new buttons // no need for atm
